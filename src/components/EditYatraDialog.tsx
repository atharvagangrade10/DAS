...
const EditYatraDialog: React.FC<EditYatraDialogProps> = ({ yatra, isOpen, onOpenChange }) => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      registration_fees: yatra.registration_fees,
      can_add_members: yatra.can_add_members,
      status: yatra.status,
    },
  });
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Update pricing and details for {yatra.name}.</DialogDescription>
        </DialogHeader>
        <Form {...form}>
